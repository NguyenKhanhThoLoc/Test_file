from src.package.TextSumarization import TextRankSummarizer
import src.package.Paddle as Paddle
from pyvi import ViTokenizer

sentence = "Với hành vi vi phạm hành chính trong lĩnh vực chứng khoán và thị trường chứng khoán, Hoàng Anh Gia Lai của bầu Đức đã bị xử phạt 60 triệu đồng."
sentence_tokenized = ViTokenizer.tokenize(sentence)
words = sentence_tokenized.split(" ")
print(words)


summarizer = TextRankSummarizer(max_sentences=5)
...
print(summary)
#img_path = '254.jpg'
#Paddle.pdf_paddle_ocr("156.pdf",lang="ch",page_num = 2)
